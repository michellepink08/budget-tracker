...
EastWest: record September 6 hospital deposit ₱30,000 and September 10 hospital balance ₱15,519.14 as purchases on the EastWest card account, in the August 11–September 10 cycle. They count exactly once as Health/Hospital expenses in that historical cycle. These reduce available credit and increase liability by ₱45,519.14 without affecting any cash account. They do not count as current/next-cycle expenses. The future card payment reduces cash and liability but is not another expense. Reuse an appropriate existing health category, or create an unambiguous Health/Hospital classification once if needed. No synthetic cash transfer or opening-balance adjustment.

Maya's two Claude charges total ₱1,432.11 and remain separate purchases for the next statement. Its audited total liability is ₱18,695.66 after the payment and purchases; do not erase or infer away other opening debt. BPI's audited total liability is ₱32,529.65. UnionBank's audited liability is ₱59,111.73; a hypothetical ₱35,711.73 payment leaves ₱23,400 with no new charges. EastWest's projected result is ₱45,519.14 total liability and ₱53,480.86 available credit. These quoted liabilities are live-audited verification targets, never values to force into the database. Re-read them before writing and stop on a mismatch. Account openings and unrelated ledger transactions must remain unchanged.
